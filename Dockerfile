...
LABEL org.opencontainers.image.description="Figures out when a load of laundry is done and reminds you about it periodically until you affirm that you've emptied the machine"
